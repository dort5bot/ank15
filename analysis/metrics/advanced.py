"""
kalman_filter_trend: "1D Kalman filter — trend smoothing and noise reduction, trend"
wavelet_transform: "Haar wavelet transform — multilevel denoising and signal reconstruction, signal_processing"
hilbert_transform_slope: "Hilbert transform — instantaneous phase slope (frequency), signal_processing"
hilbert_transform_amplitude: "Hilbert transform — instantaneous amplitude (envelope), signal_processing"
fractal_dimension_index_fdi: "Higuchi-like fractal dimension index — measures complexity or roughness, fractal"
shannon_entropy: "Shannon entropy — information entropy of distribution, entropy"
permutation_entropy: "Permutation entropy — complexity measure based on order patterns, entropy"
sample_entropy: "Sample entropy — irregularity measure of time series, entropy"
granger_causality: "Granger causality test — directional causality between two time series, causality"
phase_shift_index: "Phase shift index — average phase difference between two signals, phase"
